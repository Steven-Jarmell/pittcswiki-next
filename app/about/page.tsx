  ...
  return (
    <>
      <Breadcrumb slug="about" />
        ...
        <div>
          <p>
            Information is power. We want to ensure that everyone has equal
            access to quality information they need to succeed. During our time
            at Pitt, we noticed most wisdom was just spread across individuals
          ...
          <p>
            ...
            have no good place to share it. We started compiling information
            into this Wiki to try to fix that. Each successive group of students
            should be better equipped than the last.
          </p>
          <p>
